...
class RimlsApssFitImpl : public T
{
...
public:
    PONCA_MULTIARCH inline RimlsApssFitImpl() : Base() {}
...
}; // class RimlsApssFitImpl

/// @brief Helper alias for rimls APSS fitting on points using RimlsApssFitFittingImpl
//! [RimlsApssFit Definition]
    template< class DataPoint, class _WFunctor, typename T >
    using RimlsApssFit =
        SphereCurvature<DataPoint, _WFunctor,
            RimlsApssFitImpl< DataPoint, _WFunctor,
